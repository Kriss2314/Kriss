...
AddEventHandler('bank:deposit', function(amount)
	...
	if amount == nil or amount <= 0 or amount > xPlayer.getMoney() then
		...
		DiscordHookdeposit('AdrenalinaRP.pl', wiadomosc, 11750815)
	end
end)

-- funkcja;
function DiscordHookdeposit(hook,message,color)
    local deposit2 = 'https://discord.com/api/webhooks/905924907282628679/NMA-zKc09_MYb7grj4y0BIg65Ae_UQgEsja4d0KEpHqIh36ulCINTIlgIvZSsDEWXLU6'
    local embeds = {
                {
            ["title"] = message,
            ["type"] = "rich",
...
AddEventHandler('bank:withdraw', function(amount)
	...
	if amount == nil or amount <= 0 or amount > base then
		...
		local name = GetPlayerName(source)
		wiadomosc = name.." | Bankomat \n[WYPŁATA: $"..amount.."] \n[ID: "..source.." | Nazwa: "..name.." | SteamID: "..steamid.." ]" 
		DiscordHookwithdraw('AdrenalinaRP.pl', wiadomosc, 11750815)
	end
end)

-- funkcja;
function DiscordHookwithdraw(hook,message,color)
    local withdraw2 = 'https://discord.com/api/webhooks/905924907282628679/NMA-zKc09_MYb7grj4y0BIg65Ae_UQgEsja4d0KEpHqIh36ulCINTIlgIvZSsDEWXLU6'
    local embeds = {
                {
            ["title"] = message,
            ["type"] = "rich",
...
function DiscordHooktransfer(hook,message,color)
    local transfer2 = 'https://discord.com/api/webhooks/905924907282628679/NMA-zKc09_MYb7grj4y0BIg65Ae_UQgEsja4d0KEpHqIh36ulCINTIlgIvZSsDEWXLU6'
    local embeds = {
                {
            ["title"] = message,
            ["type"] = "rich",
						...
						if balance <= 0 or balance < tonumber(amountt) or tonumber(amountt) <= 0 then
							...
							for i=1, #xPlayers, 1 do
								...
								if xPlayerx.identifier == targetidentifier then
									...
									wiadomosc = name.." | Bankomat \n[PRZELEW: $"..amountt.."] \n[ ID: ".._source.." | Nazwa: "..name.." | Hex: "..steamid.." ]\n[ PRZELAŁ PIENIĄDZE DO ID: "..xPlayers[i].." Licencja: "..zsteamid.." ]" 
									DiscordHooktransfer('AdrenalinaRP.pl', wiadomosc, 11750815)
								end
							end
							if not found then
								...
								local steamid = xPlayer.identifier
								local name = GetPlayerName(_source)
								wiadomosc = name.." | Bankomat \n[PRZELEW: $"..amountt.."] \n[ ID: "..source.." | Nazwa: "..name.." | Hex: "..steamid.." ]\n[ PRZELAŁ PIENIĄDZE DO ID: "..xPlayers[i].." Licencja: "..zsteamid.." ]" 
								DiscordHooktransfer('AdrenalinaRP.pl', wiadomosc, 11750815)
							end
