...
Config.Animations = {
...

	{
		...
		items = {
			...
			{label = "Drapanie sie po jajach", keyword = "drapanie2", type = "anim", data = {lib = "mp_player_int_uppergrab_crotch", anim = "mp_player_int_grab_crotch"}},
			...
			{label = "Wypiecie tylka", keyword = "wypnij", type = "anim", data = {lib = "switch@trevor@mocks_lapdance", anim = "001443_01_trvs_28_exit_trv"}},
...
{label = "Twerk", keyword = "twerk", type = "anim", data = {lib = "switch@trevor@mocks_lapdance", anim = "001443_01_trvs_28_idle_stripper", mode = 1}},
			...
			{label = "Striptiz taniec v5", type = "anim", data = {lib = "mini@strip_club@lap_dance@ld_girl_a_song_a_p2", anim = "ld_girl_a_song_a_p2_f"}}
		}
	}
}
Config.Gesty = {
	...
	while true do
		...
		if Ped.Active then
			...
			if not IsEntityDead(Ped.Id) then
				Ped.Locked = (exports['gcphone']:getMenuIsOpen())
				Ped.Alive = true
